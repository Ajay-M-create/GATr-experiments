...
def generate_surface_area_dataset(filename, num_samples, num_points=80):
    """Generates a dataset of random 80-point convex hulls and their surface areas.
    ...
    num_points : int, optional
        Number of points per sample, by default 80.
    """
...
def generate_datasets(path):
    ...
    # Training dataset
    generate_surface_area_dataset(path / "train.npz", num_samples=100000, num_points=80)

    # Validation dataset
    generate_surface_area_dataset(path / "val.npz", num_samples=5000, num_points=80)

    # Test dataset
    generate_surface_area_dataset(path / "test.npz", num_samples=5000, num_points=80)

    # Generalization dataset (e.g., with more points)
    generate_surface_area_dataset(path / "generalization.npz", num_samples=5000, num_points=160)
