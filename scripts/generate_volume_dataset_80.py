...
def generate_volume_dataset(filename, num_samples, num_points=80):
    """Generates a dataset of random 80-point convex hulls and their volumes.
    ...
    num_points : int, optional
        Number of points per sample, set to 80.
    """
...
def generate_datasets(path):
    ...
    # Training dataset
    generate_volume_dataset(path / "train.npz", num_samples=100000, num_points=80)

    # Validation dataset
    generate_volume_dataset(path / "val.npz", num_samples=5000, num_points=80)

    # Test dataset
    generate_volume_dataset(path / "test.npz", num_samples=5000, num_points=80)

    # Generalization dataset (e.g., with more points)
    generate_volume_dataset(path / "generalization.npz", num_samples=5000, num_points=80)
...
def main(cfg):
    """Entry point for volume dataset generation with 80 points."""
    data_dir = cfg.data.data_dir_80
