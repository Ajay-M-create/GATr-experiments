...
echo $BASEDIR
python ../scripts/symmetry_experiment.py base_dir="${BASEDIR}" seed=42 model=transformer_symmetry data.subsample=0.01 training.steps=5000 run_name=transformer_symmetry