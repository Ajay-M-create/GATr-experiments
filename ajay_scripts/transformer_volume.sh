...
echo $BASEDIR
python ../scripts/volume_experiment.py base_dir="${BASEDIR}" seed=42 model=transformer_volume data.subsample=0.05 training.steps=10000 run_name=transformer_volume